...
<img
  ...
  src="/images/auxvault-logo-light.png"
  alt="AuxVault Logo Light"
/>
<img
  className="hidden dark:block"
  src="/images/auxvault-logo-dark.png"
...
<CardGroup cols={3}>
  <Card
    ...
    icon="credit-card"
    href="/api-reference/endpoints/transaction"
  >
  ...
  <Card
    ...
    icon="rotate-left"
    href="/api-reference/endpoints/refund"
  >
  ...
  <Card
    ...
    icon="calendar-check"
    href="/api-reference/endpoints/recurring"
  >
...
<CardGroup cols={2}>
  <Card
    title="Customer API"
    icon="users"
    href="/api-reference/endpoints/customer"
  >
  ...
  <Card
    ...
    href="/api-reference/endpoints/transaction-retrieval"
  >
