...
<CardGroup cols={2}>
  <Card
    ...
    icon="credit-card"
    href="/api-reference/card-transaction"
  >
  ...
  <Card
    ...
    icon="rotate-left"
    href="/api-reference/refund-transaction"
  >
...
<CardGroup cols={2}>
  <Card
    title="Customer API"
    icon="users"
    href="/api-reference/customer-list"
  >
  ...
  <Card
    ...
    href="/api-reference/transaction-list"
  >
...
<CardGroup cols={1}>
  <Card
    ...
    icon="cart"
    href="/integrations/woocommerce/overview"
  >
